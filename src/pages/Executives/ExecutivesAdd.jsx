...
function ExecutivesAdd() {
  ...
  const handleSubmit = () => {
      ...
      if (Object.keys(handleValidationObject).length > 0) {
          ...
          formData.append("role", addProducForm.role);
          formData.append("category", 'executives');
                  ...
                  <div className="container">
                      ...
                      <div className="row my-2">
                          ...
                          <div className="col-md-4 text-end">
                              <button
                                  ...
                                  disabled>
                                  <Link to="/executives-add">Add executives </Link>
                              </button>
                              <button type="button" className="btn btn-outline-success mx-1">
                                  <Link to="/executives-list"> executives List</Link>
                              </button>
                      ...
                      <div className="row m-auto my-3">
                          ...
                          <div className="col-md-6">
                              <Row className="mb-3">
                                  <Form.Group as={Col}>
                                      <Form.Label>Executives Heading</Form.Label>
                                      <Form.Control
                                          type="text"
                                          placeholder="Executives name"
                                          name='heading'
                              ...
                              <Row className="mb-3">
                                  <Form.Group as={Col}>
                                      <Form.Label>Executives Role</Form.Label>
                                      <Form.Control
                                          type="text"
                                          placeholder="Executives name"
                                          name='role'
                                          value={addProducForm.role}
                                          onChange={handleChange}
                                          autoComplete='off'
                                      />
                                      <span className="text-danger" >{addProductFormErros.heading}</span>
                              ...
                              <Form.Group className="mb-3">
                                  <Form.Label>Executives Description</Form.Label>
                                  <Form.Control
                                      as="textarea"
                                      rows={4}
                                      placeholder="Executives Description"
                                      name='text'
