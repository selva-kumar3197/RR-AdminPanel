...
function WerehouseGalleryList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/warehouse_service_gallery`,
    })
      .then((res) => {
        if (res.status == 200) {
          setRowdata(res.data);
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "warehouse_service_gallery");
...
export default WerehouseGalleryList;
