...
function WerehouseTeamList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/warehouse_services`,
    })
      .then((res) => {
        if (res.status == 200) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "warehouse_services");
          ...
          <div className="container ">
            ...
            <div className="row my-2">
              <div className="col-md-3">
                <h3>
                  <b> Warehouse Team List </b>
                </h3>
              </div>
              <div className="col-md-9 text-end">
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/WerehouseAddTeam">Add Warehouse Team</Link>
                </button>
                <button
                  type="button"
                  ...
                  disabled
                >
                  <Link to="/WerehouseTeamList">Warehouse Team List</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/AddWerehouseGallery">Add Warehouse Gallery</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/WerehouseGalleryList">
                    Warehouse Gallery List{" "}
                  </Link>
                </button>
              </div>
            </div>
...
export default WerehouseTeamList;
