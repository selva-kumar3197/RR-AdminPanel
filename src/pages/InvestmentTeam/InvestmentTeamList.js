...
function InvestmentTeamList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/investment_advisory`,
    })
      .then((res) => {
        if (res.status == 200) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "investment_advisory");
...
export default InvestmentTeamList;
