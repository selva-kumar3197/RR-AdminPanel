...
function InvestmentGalleryList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/investment_service_gallery`,
    })
      .then((res) => {
        if (res.status == 200) {
          setRowdata(res.data.revserse());
        }
      })
      .catch((err) => {
        console.log(err, "err");
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "investment_service_gallery");
    ...
    //   formData.append("designation", updateMemberForm.text);
    // }
          ...
          <div className="container ">
            ...
            <div className="row my-2">
              <div className="col-md-3">
                <h3>
                  <b>Investment Gallery List </b>
                </h3>
              </div>
              <div className="col-md-9 text-end">
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/AddinvestmentTeam">Add Investment Team</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/InvestmentTeamList">Investment Team List</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/AddInvestmentGallery">Add Investment Gallery</Link>
                </button>
                <button
                  type="button"
                  ...
                  disabled
                >
                  <Link to="/InvestmentGalleryList">
                    Investment Gallery List
                  </Link>
                </button>
              </div>
            </div>
...
export default InvestmentGalleryList;
