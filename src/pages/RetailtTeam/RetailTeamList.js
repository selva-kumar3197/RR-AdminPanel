...
function RetailTeamList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/retail_services`,
    })
      .then((res) => {
        if (res.status == 200) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "retail_services");
            ...
            <div className="row my-2">
              ...
              <div className="col-md-9 text-end">
                ...
                <button
                  ...
                  disabled
                >
                  <Link to="/RetailTeamList">Retail Team List</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/AddRetailGallery">Add Retail Gallery</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/RetailGalleryList">Retail Gallery List</Link>
                </button>
              </div>
            </div>
