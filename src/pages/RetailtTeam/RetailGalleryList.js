...
function RetailGalleryList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/retail_service_gallery`,
    })
      .then((res) => {
        if (res.status == 200) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "retail_service_gallery");
...
export default RetailGalleryList;
