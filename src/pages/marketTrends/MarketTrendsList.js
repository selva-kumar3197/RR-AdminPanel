...
function MarketTrendsList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/market_trends`,
    })
      .then((res) => {
        if (res.status == 200) {
          ...
          <div className="container ">
            ...
            <div className="row my-2">
              <div className="col-md-3">
                <h3>
                  <b>All MarketTrend List </b>
                </h3>
              </div>

              <div className="col-md-4 text-end">
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/markettrend">Add MarketTrend </Link>
                </button>
                <button
                  type="button"
                  ...
                  disabled
                >
                  <Link to="/markettrend-list"> MarketTrend List</Link>
                </button>
              </div>
            </div>
