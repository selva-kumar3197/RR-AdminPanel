...
const PrNews = () => {
  ...
  const handleSubmit = () => {
    ...
    if (Object.keys(handleValidationObject).length > 0) {
      ...
      formData.append("report_date", addProducForm.report_date);
      formData.append("link", addProducForm.link);
            ...
            <div className="row my-2">
              ...
              <div className="col-md-4 text-end">
                <button
                  ...
                  disabled
                >
                  <Link to="/blog-add">Add Article </Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/blog-list"> Article List</Link>
                </button>
              </div>
            </div>
                ...
                <Row className="mb-3">
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      ...
                      name="report_date"
                      value={addProducForm.report_date}
                      onChange={handleChange}
                      autoComplete="off"
                    />
                    <span className="text-danger">
                      {addProductFormErros.report_date}
                    </span>
                  </Form.Group>
                </Row>
                <Row className="mb-3">
                  <Form.Group as={Col}>
                    ...
                    <Form.Control
                      ...
                      placeholder="link"
                      name="link"
                      value={addProducForm.link}
                      onChange={handleChange}
                      autoComplete="off"
                    />
                    <span className="text-danger">
                      {addProductFormErros.link}
                    </span>
                  </Form.Group>
                </Row>
                <Row>
