...
import TeamRRCategoryList from "./Team@RRCategoryList";

const CreateCategoryTeam = () => {
  /** State Management **/
  ...
  const handleSubmit = () => {
    ...
    if (Object.keys(handleValidationObject).length > 0) {
      ...
      //   formData.append("link", addProducForm.text);
      formData.append("category", "team@rr_category");
...
export default CreateCategoryTeam;
