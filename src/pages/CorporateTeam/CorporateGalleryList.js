...
function CorporateGalleryList() {
  ...
  const productsListApi = () => {
    axios({
      mathod: "GET",
      url: `${baseURL}/category/corporate_service_gallery`,
    })
      .then((res) => {
        if (res.status == 200) {
  ...
  const handleSubmit = () => {
    ...
    formData.append("category", "corporate_service_gallery");
          ...
          <div className="container ">
            ...
            <div className="row my-2">
              <div className="col-md-3">
                <h3>
                  <b>Corporate Gallery List </b>
                </h3>
              </div>
              <div className="col-md-9 text-end">
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/AddCorporateTeam">Add Corporate Team </Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/CorporateTeamList">Corporate Team List</Link>
                </button>
                <button type="button" className="btn btn-outline-success mx-1">
                  <Link to="/AddCorporateGallery">Add Corporate Gallery</Link>
                </button>
                <button
                  type="button"
                  ...
                  disabled
                >
                  <Link to="/CorporateGalleryList">Corporate Gallery List</Link>
                </button>
              </div>
            </div>
...
export default CorporateGalleryList;
